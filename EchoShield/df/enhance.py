...
def enhance(
    ...
    if pad:
        n_fft = df_state.fft_size() if callable(df_state.fft_size) else df_state.fft_size
        hop = df_state.hop_size() if callable(df_state.hop_size) else df_state.hop_size
